...
export const NavigationBanners = () => {
    ...
    return (
        <div className="w-full flex mt-40 relative" >
            ...
            <div className=" group relative w-3/5 h-160 bg-green-500 rounded-4xl z-10"
        ...
        transition-all duration-500 ease-in-out 
            ...
            <div className="group relative w-2/5 h-160 bg-amber-400 rounded-4xl z-10"
