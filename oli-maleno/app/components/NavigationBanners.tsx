...
export const NavigationBanners = () => {
    ...
    return (
        <div className="w-full flex flex-col md:flex-row mt-26 relative" >
            ...
            <div className="group relative w-full md:w-3/5 h-160 bg-green-500 rounded-4xl z-10 cursor-pointer"
