    ...
    return (
        <>
            <div className="flex flex-col flex-1 items-center justify-center bg-white overflow-hidden">
                ...
                <main className="flex flex-col gap-16 md:gap-36 w-full flex-1 pt-8 md:py-36">
                    <h1 className='flex flex-col gap-6 md:mx-12'><span className='text-8xl text-[#666]'>TÉRMINOS Y</span> <span className='text-8xl'>CONDICIONES</span></h1>
