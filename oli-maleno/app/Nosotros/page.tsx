    ...
    return (
        <>
            <div className="flex flex-col flex-1 items-center justify-center bg-white overflow-hidden">
                ...
                <Header />
                <main className="flex flex-col gap-16 md:gap-36 max-w-11/12 md:max-w-3/5 flex-1 pt-24  md:py-36">
                    <h1 className='flex flex-col gap-6 '><span className='text-5xl md:text-8xl text-[#666]'>SOBRE</span> <span className='text-5xl md:text-8xl'>NOSOTROS</span></h1>
                    <div className="flex flex-col md:gap-20  mx-auto items-center">
